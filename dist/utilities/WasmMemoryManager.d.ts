...
declare abstract class TypedArrayRef<T extends TypedArray> {
    ...
    slice(start?: number, end?: number): Uint8Array<ArrayBuffer> | Int32Array<ArrayBuffer> | Float32Array<ArrayBuffer> | Float64Array<ArrayBuffer> | Int8Array<ArrayBuffer> | Int16Array<ArrayBuffer> | Uint8ClampedArray<ArrayBuffer> | Uint16Array<ArrayBuffer> | Uint32Array<ArrayBuffer>;
    get address(): number;
    clear(): this;
    free(): void;
    clearAddress(): void;
